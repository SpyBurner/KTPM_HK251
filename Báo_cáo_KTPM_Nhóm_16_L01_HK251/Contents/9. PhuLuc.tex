\section{Phụ lục}
\subsection{ADR}
\subsubsection{ADR 00: Lựa chọn kiến trúc ban đầu: Microservices Architecture (MSA)} \label{adr:00}
...
\subsubsection{ADR 01: Chuyển đổi kiến trúc từ Microservices (MSA) sang Service-Based Architecture (SBA)} \label{adr:01}
